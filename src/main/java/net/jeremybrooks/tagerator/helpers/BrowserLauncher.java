 ...
 *
 * TODO: This class needs to be overhauled. It's old.... but it works. -- jb
 */
public class BrowserLauncher {
	...
	switch (jvm) {
	    ...
	    case OTHER:
	    default:
		// SEARCH FOR ANOTHER BROWSER IN THIS ORDER:
		// opera, mozilla-firefox, firefox, mozilla
		// DEFAULT TO netscape
		if (testBrowserOnUnix("opera")) {
		    browser = "opera";
		} else if (testBrowserOnUnix("mozilla-firefox")) {
		    browser = "mozilla-firefox";
		} else if (testBrowserOnUnix("firefox")) {
		    browser = "firefox";
		} else if (testBrowserOnUnix("mozilla")) {
		    browser = "mozilla";
		} else {
		    browser = "netscape";
		}
    ...
    /**
     * Search for broswer by calling "which <browser>".
     * If which returns something, return true.
     * @return true if which arg finds something, false otherwise.
     */
    private static boolean testBrowserOnUnix(String browser) {
	boolean retVal = false;

	try {
	    Process p = Runtime.getRuntime().exec("which " + browser);
